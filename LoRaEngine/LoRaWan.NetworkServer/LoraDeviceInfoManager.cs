...
namespace LoRaWan.NetworkServer
{
    public class LoraDeviceInfoManager
    {
        ...
        public static async Task<LoraDeviceInfo> PerformOTAAAsync(string DevEUI, string AppEUI, string DevNounce)
        {
            var client = new HttpClient();         

            var url = $"{FacadeServerUrl}PerformOTAA?code={FacadeAuthCode}&DevEUI={DevEUI}&DevNounce={DevNounce}&AppEUI={AppEUI}";
